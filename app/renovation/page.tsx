...
export default function RenovationPage() {
  ...
  return <main className={`renovation-page language-${lang}`}>
    <header className="site-header subpage-header"><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><nav><a href="/"><L en="Home" ml="ഹോം"/></a><a href="/#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="#details"><L en="Project details" ml="പദ്ധതി വിവരങ്ങൾ"/></a><a href="#document"><L en="Full document" ml="പൂർണ്ണ രേഖ"/></a></nav><button className="language-toggle" onClick={() => setLang(lang === "en" ? "ml" : "en")} aria-label="Change language"><span className={lang === "en" ? "active" : ""}>EN</span><i/><span className={lang === "ml" ? "active" : ""}>മ</span></button></header>

    <section className="renovation-hero"><div className="renovation-hero-copy"><p className="eyebrow"><span/><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></p><h1><L en={<>Temple renovation<br/><em>details</em></>} ml={<>ക്ഷേത്ര പുനരുദ്ധാരണ<br/><em>വിവരങ്ങൾ</em></>}/></h1></div><div className="renovation-hero-media"><img src={`${mediaHost}/gallery/renewal-model.jpg`} alt="Proposed Manakottukavu temple model"/></div></section>
    ...
    <section className="committee-section"><h2><L en="Official contacts" ml="ഔദ്യോഗിക ബന്ധപ്പെടൽ"/></h2><div><a href="tel:+919745822535"><span><L en="President" ml="പ്രസിഡന്റ്"/></span><b>Ajish Kumar</b><strong>97458 22535</strong></a><a href="tel:+918848403303"><span><L en="Secretary" ml="സെക്രട്ടറി"/></span><b>K. Saji</b><strong>88484 03303</strong></a><a href="tel:+919441270765"><span><L en="Treasurer" ml="ട്രഷറർ"/></span><b>K. A. Ashok Kumar</b><strong>94412 70765</strong></a></div></section>

    <section className="document-section" id="document"><div className="document-heading"><p className="section-kicker"><L en="Complete source document" ml="പൂർണ്ണ ഔദ്യോഗിക രേഖ"/></p><h2><L en="Renovation project booklet" ml="പുനരുദ്ധാരണ പദ്ധതി രേഖ"/></h2></div><div className="document-pages">{documentPages.map((src,i)=><button className="document-page" key={src} onClick={() => setOpenPage(i)} aria-label={lang === "en" ? `Open booklet page ${i+1}` : `പുസ്തികയുടെ പേജ് ${i+1} തുറക്കുക`}><img src={src} alt={`Manakottukavu renovation booklet page ${i+1}`} loading="lazy"/><span><L en={`Page ${i+1} · Click to read`} ml={`പേജ് ${i+1} · വായിക്കാൻ ക്ലിക്ക് ചെയ്യുക`}/></span></button>)}</div></section>
    ...
    <footer><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><p><L en="Palayam Devaswom, Mullurkkara, Thrissur, Kerala." ml="പാലയം ദേവസ്വം, മുള്ളൂർക്കര, തൃശ്ശൂർ, കേരളം."/></p><div><a href="/">Home</a><a href="/#offerings">Offerings</a><a href="tel:+918129026387">Contact</a></div><small>© {new Date().getFullYear()} Manakottukavu Trust</small></footer>
  </main>;
}
