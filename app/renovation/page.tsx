...
export default function RenovationPage() {
  ...
  return <main className={`renovation-page language-${lang}`}>
    ...
    <section className="renovation-hero"><div className="renovation-hero-copy"><p className="eyebrow"><span/><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></p><h1><L en={<>Temple renovation<br/>details</>} ml={<>ക്ഷേത്ര പുനരുദ്ധാരണ<br/>വിവരങ്ങൾ</>}/></h1></div><div className="renovation-hero-media"><img src="/renovation/manakottukavu-renovation-visual.png" alt="Architectural visualization of the proposed Manakottukavu temple renovation"/></div></section>
