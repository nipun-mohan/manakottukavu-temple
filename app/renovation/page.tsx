...
export default function RenovationPage() {
  ...
  return <main className={`renovation-page language-${lang}`}>
    <header className="site-header subpage-header"><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><nav aria-label="Primary navigation"><a href="/"><L en="Home" ml="ഹോം"/></a><a href="/#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></a><a href="#details"><L en="Project details" ml="പദ്ധതി വിവരങ്ങൾ"/></a><a href="#document"><L en="Project Booklet" ml="പദ്ധതി പുസ്തിക"/></a></nav><div className="header-actions"><button className="language-toggle" onClick={toggleLanguage} aria-label="Change language"><span className={lang === "en" ? "active" : ""}>EN</span><i/><span className={lang === "ml" ? "active" : ""}>മ</span></button><details className="mobile-menu"><summary aria-label={lang === "en" ? "Open menu" : "മെനു തുറക്കുക"}><span/><span/><span/></summary><nav aria-label="Mobile navigation"><a href="/"><L en="Home" ml="ഹോം"/></a><a href="/#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></a><a href="#details"><L en="Project details" ml="പദ്ധതി വിവരങ്ങൾ"/></a><a href="#document"><L en="Project Booklet" ml="പദ്ധതി പുസ്തിക"/></a></nav></details></div></header>

    <section className="renovation-hero"><div className="renovation-hero-copy"><p className="eyebrow"><span/><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></p><h1><L en={<>Temple renovation<br/>details</>} ml={<>ക്ഷേത്ര പുനരുദ്ധാരണ<br/>വിവരങ്ങൾ</>}/></h1></div><div className="renovation-hero-media"><img src="/renovation/manakottukavu-renovation-visual-clean.png" alt="Architectural visualization of the proposed Manakottukavu temple renovation"/></div></section>
    ...
    <footer><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><p><L en="Manakottukavu Trust, Mullurkkara, Thrissur, Kerala." ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്, മുള്ളൂർക്കര, തൃശ്ശൂർ, കേരളം."/></p><div><a href="/">Home</a><a href="/#offerings">Offerings</a><a href="tel:+918129026387">Contact</a></div><small className="footer-bottom"><span>© {new Date().getFullYear()} Manakottukavu Trust</span><span>Reg. No. 28/IV/2025</span><span>Site managed by Nipun Mohan</span></small></footer>
  </main>;
}
