...
export default function RenovationPage() {
  ...
  return <main className={`renovation-page language-${lang}`}>
    ...
    <section className="committee-section"><h2><L en="Official contacts" ml="ഔദ്യോഗിക ബന്ധപ്പെടൽ"/></h2><div><a href="tel:+919745822535"><span><L en="President" ml="പ്രസിഡന്റ്"/></span><b>Ajesh Kumar</b><strong>97458 22535</strong></a><a href="tel:+918848403303"><span><L en="Secretary" ml="സെക്രട്ടറി"/></span><b>K. Ravi</b><strong>88484 03303</strong></a><a href="tel:+919441270765"><span><L en="Treasurer" ml="ട്രഷറർ"/></span><b>K. E. Ahsok Kumar</b><strong>94412 70765</strong></a></div></section>
