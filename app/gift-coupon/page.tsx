...
export default function GiftCouponPage() {
  ...
  return <main className={`gift-page language-${lang}`}>
    <header className="site-header subpage-header"><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><nav aria-label="Primary navigation"><a href="/"><L en="Home" ml="ഹോം"/></a><a href="/#event" aria-current="page"><L en="Upcoming Event" ml="വരാനിരിക്കുന്ന പരിപാടി"/></a><a href="/#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Temple Committee" ml="ക്ഷേത്ര കമ്മിറ്റി"/></a><a href="/renovation"><L en="Renovation" ml="പുനരുദ്ധാരണം"/></a></nav><div className="header-actions"><button className="language-toggle" onClick={toggleLanguage} aria-label="Change language"><span className={lang === "en" ? "active" : ""}>EN</span><i/><span className={lang === "ml" ? "active" : ""}>മ</span></button><details className="mobile-menu"><summary aria-label={lang === "en" ? "Open menu" : "മെനു തുറക്കുക"}><span/><span/><span/></summary><nav aria-label="Mobile navigation"><a href="/"><L en="Home" ml="ഹോം"/></a><a href="/#event"><L en="Upcoming Event" ml="വരാനിരിക്കുന്ന പരിപാടി"/></a><a href="/#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Temple Committee" ml="ക്ഷേത്ര കമ്മിറ്റി"/></a><a href="/renovation"><L en="Renovation" ml="പുനരുദ്ധാരണം"/></a></nav></details></div></header>

    <section className="gift-hero"><div><p className="section-kicker"><L en="Renovation fundraiser" ml="പുനരുദ്ധാരണ ധനസമാഹരണം"/></p><h1><L en="Gift Coupon" ml="സമ്മാന കൂപ്പൺ"/></h1><p><L en="Join the Manakottukavu renovation fundraiser and participate in the Vishu Gift Coupon draw." ml="മനക്കോട്ടുകാവ് പുനരുദ്ധാരണ ധനസമാഹരണത്തിന്റെ ഭാഗമായി നടത്തുന്ന വിഷു സമ്മാന കൂപ്പൺ നറുക്കെടുപ്പിൽ പങ്കെടുക്കൂ."/></p><div className="gift-facts"><div><span><L en="Coupon" ml="കൂപ്പൺ"/></span><strong>₹200</strong></div><div><span><L en="Draw date" ml="നറുക്കെടുപ്പ്"/></span><strong><L en="15 April 2027" ml="2027 ഏപ്രിൽ 15"/></strong></div><div><span><L en="Time & venue" ml="സമയവും വേദിയും"/></span><strong><L en="3:00 PM · Temple Sannidhi" ml="വൈകിട്ട് 3 മണി · ക്ഷേത്ര സന്നിധി"/></strong></div></div><a className="gift-contact" href="tel:+918129026387"><L en="Call for coupons · +91 81290 26387" ml="കൂപ്പണുകൾക്കായി വിളിക്കുക · +91 81290 26387"/></a></div><figure><img src="/events/gift-coupon.jpg" alt={lang === "en" ? "Manakottukavu Gift Coupon" : "മനക്കോട്ടുകാവ് സമ്മാന കൂപ്പൺ"}/><figcaption><L en="Official Gift Coupon · Images on the coupon are for illustration; actual products may vary." ml="ഔദ്യോഗിക സമ്മാന കൂപ്പൺ · ചിത്രങ്ങൾ സൂചനയ്ക്കായി മാത്രം; യഥാർത്ഥ ഉൽപ്പന്നങ്ങളിൽ വ്യത്യാസമുണ്ടാകാം."/></figcaption></figure></section>
    ...
    <section className="gift-note"><p><L en="Coupon proceeds support the renovation of Manakottukavu Temple. Contact the temple committee to obtain coupons and confirm participation details." ml="കൂപ്പൺ വരുമാനം മനക്കോട്ടുകാവ് ക്ഷേത്ര പുനരുദ്ധാരണത്തിന് വിനിയോഗിക്കും. കൂപ്പൺ ലഭിക്കാനും പങ്കാളിത്ത വിവരങ്ങൾ ഉറപ്പാക്കാനും ക്ഷേത്ര സമിതിയെ ബന്ധപ്പെടുക."/></p><a href="tel:+918129026387">+91 81290 26387</a></section>
