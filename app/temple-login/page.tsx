  ...
  return <main className={`login-page language-${lang}`}>
    ...
    <section className="login-shell">
      <div className="login-card">
        ...
        <p><L en="Secure access for authorised temple administrators to update offering prices." ml="വഴിപാട് നിരക്കുകൾ പുതുക്കുന്നതിനുള്ള അംഗീകൃത ക്ഷേത്ര ഭാരവാഹികളുടെ സുരക്ഷിത പ്രവേശനം."/></p>
