...
export default function Home() {
  ...
  return <main className={`language-${lang}`}>
    ...
    <footer><a className="brand" href="#home"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><p><L en="Manakottukavu Trust, Mullurkkara, Thrissur, Kerala." ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്, മുള്ളൂർക്കര, തൃശ്ശൂർ, കേരളം."/></p><div><a href="#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Manakottukavu Trust" ml="മനക്കോട്ടുകാവ് ട്രസ്റ്റ്"/></a><a href="/renovation"><L en="Renovation" ml="പുനരുദ്ധാരണം"/></a><a href={facebookUrl} target="_blank" rel="noreferrer">Facebook</a><a className="admin-login-link" href="/temple-login"><L en="Admin Login" ml="അഡ്മിൻ ലോഗിൻ"/></a></div><small className="footer-bottom"><span>© {new Date().getFullYear()} Manakottukavu Trust</span><span>Reg. No. 28/IV/2025</span><span>Site managed by Nipun Mohan</span></small></footer>
  </main>;
}
