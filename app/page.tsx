...
export default function Home() {
  ...
  return <main className={`language-${lang}`}>
    <header className="site-header home-header">
      ...
      <nav aria-label="Primary navigation"><a href="#home"><L en="Home" ml="ഹോം"/></a><a href="#event"><L en="Upcoming Event" ml="വരാനിരിക്കുന്ന പരിപാടി"/></a><a href="#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Temple Committee" ml="ക്ഷേത്ര കമ്മിറ്റി"/></a><a href="#contact"><L en="Contact" ml="ബന്ധപ്പെടുക"/></a><a href="/renovation"><L en="Renovation" ml="പുനരുദ്ധാരണം"/></a></nav>
    ...
    <section className="upcoming-event reveal" id="event"><div className="event-copy"><p className="section-kicker"><L en="Upcoming event" ml="വരാനിരിക്കുന്ന പരിപാടി"/></p><h2><L en="Renovation Gift Coupon" ml="പുനരുദ്ധാരണ സമ്മാന കൂപ്പൺ"/></h2><p><L en="Support the Manakottukavu renovation and take part in the Gift Coupon draw. Coupons are ₹200 each, with prizes including a Honda Dio scooter, air conditioner, television and more." ml="മനക്കോട്ടുകാവ് പുനരുദ്ധാരണ പ്രവർത്തനങ്ങളെ സഹായിക്കാൻ സമ്മാന കൂപ്പൺ നറുക്കെടുപ്പിൽ പങ്കെടുക്കൂ. ഒരു കൂപ്പണിന് ₹200. ഹോണ്ട ഡിയോ സ്കൂട്ടർ, എയർ കണ്ടീഷണർ, ടെലിവിഷൻ തുടങ്ങി നിരവധി സമ്മാനങ്ങൾ."/></p><dl><div><dt><L en="Draw" ml="നറുക്കെടുപ്പ്"/></dt><dd><L en="15 April 2027 · 3:00 PM" ml="2027 ഏപ്രിൽ 15 · വൈകിട്ട് 3 മണി"/></dd></div><div><dt><L en="Venue" ml="വേദി"/></dt><dd><L en="Manakottukavu Sannidhi" ml="മനക്കോട്ടുകാവ് സന്നിധി"/></dd></div></dl><a className="event-link" href="/gift-coupon"><L en="View coupon details" ml="കൂപ്പൺ വിശദാംശങ്ങൾ കാണുക"/><span>→</span></a></div><a className="event-poster" href="/gift-coupon" aria-label={lang === "en" ? "View Gift Coupon details" : "സമ്മാന കൂപ്പൺ വിശദാംശങ്ങൾ കാണുക"}><img src="/events/gift-coupon.jpg" alt={lang === "en" ? "Manakottukavu renovation Gift Coupon" : "മനക്കോട്ടുകാവ് പുനരുദ്ധാരണ സമ്മാന കൂപ്പൺ"}/></a></section>
    ...
    <section className="contact-section" id="contact"><div><p className="section-kicker"><L en="Visit & contact" ml="സന്ദർശനവും ബന്ധപ്പെടലും"/></p><h2><L en="Manakottukavu, Mullurkkara" ml="മനക്കോട്ടുകാവ്, മുള്ളൂർക്കര"/></h2><a className="primary-contact" href="tel:+918129026387">+91 81290 26387</a></div><div className="contact-card"><span><L en="Temple committee" ml="ക്ഷേത്ര സമിതി"/></span><a href="tel:+919745822535"><b>Ajesh Kumar</b><small><L en="President" ml="പ്രസിഡന്റ്"/> · 97458 22535</small></a><a href="tel:+918848403303"><b>K. Ravi</b><small><L en="Secretary" ml="സെക്രട്ടറി"/> · 88484 03303</small></a><a href="tel:+919441270765"><b>K. E. Ahsok Kumar</b><small><L en="Treasurer" ml="ട്രഷറർ"/> · 94412 70765</small></a></div></section>

    <footer><a className="brand" href="#home"><span className="brand-mark" aria-hidden="true">ॐ</span><span><b>MANAKOTTUKAVU</b><small>മനക്കോട്ടുകാവ്</small></span></a><p><L en="Paliam Devaswom, Mullurkkara, Thrissur, Kerala." ml="പാലിയം ദേവസ്വം, മുള്ളൂർക്കര, തൃശ്ശൂർ, കേരളം."/></p><div><a href="#offerings"><L en="Offerings" ml="വഴിപാടുകൾ"/></a><a href="/committee"><L en="Committee" ml="കമ്മിറ്റി"/></a><a href="/renovation"><L en="Renovation" ml="പുനരുദ്ധാരണം"/></a><a href={facebookUrl} target="_blank" rel="noreferrer">Facebook</a></div><small>© {new Date().getFullYear()} Manakottukavu</small></footer>
  </main>;
}
